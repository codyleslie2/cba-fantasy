...
import punishmentEditorialJson from "../../data/season-recaps/punishment-editorial.json";
...
const editorial=Object.fromEntries(Object.entries(editorialJson).map(([year,copy])=>[year,{...copy,stupidestLoser:(punishmentEditorialJson as Record<string,string>)[year],managerSummaries:(managerSummariesJson as Record<string,Record<string,string>>)[year]}])) as Record<string,RecapEditorial>;
